class Manager::AbsencesController < ApplicationController
  ...
  def index
    # Apply filters to demo data (displayed but not functional as per requirements)
  ...
  def create
    ...
    redirect_to manager_absences_path, notice: 'Absence créée avec succès.'
  end
  ...
  def update
    ...
    redirect_to manager_absence_path(@absence[:id]), notice: 'Absence mise à jour avec succès.'
  end

  def destroy
    # Simulate deletion
    redirect_to manager_absences_path, notice: 'Absence supprimée avec succès.'
  end
  ...
  def set_absence
    ...
    unless @absence
      redirect_to manager_absences_path, alert: 'Absence non trouvée.'
    end
  end
  ...
  def load_demo_data
    ...
    # Demo absences with all required fields from data_model.md
    @all_absences = [
      {
        id: 1,
        user_id: 1,
